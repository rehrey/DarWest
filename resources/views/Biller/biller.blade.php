...
@section('contents')
    ...
    <body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled           aside-fixed">
                            ...
                            <div class="container-fluid">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-white mb-0 px-0 py-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Biller</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                                ...
                                                <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                                    <div class="card-header align-items-center  border-bottom-dark px-0">
                                                        <div class="card-title mb-0">
                                                            <h3 class="card-label mb-0 font-weight-bold text-body">Biller
                                                            </h3>
                                                        </div>
                                                                                    ...
                                                                                    <div class="card-toolbar text-right">
                                                                                        ...
                                                                                        <div class="dropdown-menu dropdown-menu-right"
                                                                                            ...
                                                                                            <a class="dropdown-item"
                                                                                                data-toggle="modal"
                                                                                                data-target="#edit_biller{{  $biller->id  }}">Edit</a>

                                                                                            {{-- ----delete button--------- --}}
                                                                                            <a class="dropdown-item"
                                                                                            data-toggle="modal"
                                                                                            data-target="#delete_biller{{ $biller->id }}"
                                                                                                title="Delete"
                                                                                                >Delete</a>
                                                                                        </div>
                                                                                    </div>
                                                                                                 ...
                                                                                                 <form id="myform"
                                                                                                     ...
                                                                                                     <div
                                                                                                         ...
                                                                                                         <div
                                                                                                             ...
                                                                                                             <div>
                                                                                                                 <div>
                                                                                                                 <h5 >Are You sure you want to delete Biller {{ $biller->name }}?
                                                                                                                </h5>
                                                                                                                </div>
                                                                                                             </div>
                                                                                                     ...
                                                                                                     <div class="modal-footer">
                                                                                                        ...
                                                                                                        <a href="{{ URL::to('del_biller',['id'=>\base64_encode($biller->id)]) }}"  class="btn btn-primary">Delete</a>
        ...
        <div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
            ...
            <span id="check_biller_span" style="color:red"></span>

            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
                <h4 class="font-size-h4 font-weight-bold m-0">Add Biller
                </h4>
            ...
            <form id="myform" method="post" action="{{ URL::to('add_biller') }}">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control check_biller" id="check_biller_name">
                            <small class="form-text text-muted">please enter Biller Name</small>
                        </div>

                        <div class="form-group">
                            <label class="text-dark">Email</label>
                            <input type="email" name="email" class="form-control check_biller" id="check_biller_email">
                ...
                <button type="submit" class="btn btn-primary" id="add_btn_biller">Add Biller</button>
            </form>
    ...
    $(document).on('keyup','.check_biller',function()
    {
            // var supplier_name=$(this).val();
            var biller_name=document.getElementById('check_biller_name').value;
            var biller_email=document.getElementById('check_biller_email').value;
            // Ajax to load pump price
            console.log(biller_email);
            console.log(biller_name);
            $.ajax({type:'get', url:'{!! URL::to('check_biller') !!}', //URL to load the data
                data:{
                    'name': biller_name,
                    'email':biller_email,
                }, 
                ...
                success:function(data){
                    console.log(data);
                    if(data>=1){
                        var span_sms=document.getElementById('check_biller_span');
                        span_sms.innerHTML="* Biller already exist!";
                        document.getElementById("add_btn_biller").disabled = true;
                    }
                    else{
                        var span_sms=document.getElementById('check_biller_span');
                        span_sms.innerHTML=" ";
                        document.getElementById("add_btn_biller").disabled = false;
                    }
                },
                error:function(){
                },
