...
@section('contents')
                                                ...
                                                <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                                    <div class="card-header align-items-center  border-bottom-dark px-0">
                                                        <div class="card-title mb-0">
                                                            <h3 class="card-label mb-0 font-weight-bold text-body">Location
                                                            </h3>
                                                        </div>
                                                                                ...
                                                                                <div class="card-toolbar text-right">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right"
                                                                                        ...
                                                                                        <a class="dropdown-item"
																							...
																							data-target="#edit_location{{ $location->id }}">Edit</a>
                                                                                        <a class="dropdown-item"
                                                                                            title="Delete"
                                                                                            href="#" data-toggle="modal"
																							data-target="#deletelocation{{ $location->id }}">Delete</a>
                                                                                    </div>
                                                                                </div>
		...
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					action="{{ URL::to('upd_location') }}">
					@csrf
						<div class="row">
							<div class="col-12">
								<input type="text" value="{{ \base64_encode($location->id) }}"
                                hidden name="id" />
								<div class="form-group">
									<label class="text-dark">Location Name</label>
									<input type="text" class="form-control" placeholder="Medicine location Name"
    ...
    <div class="modal fade" id="deletelocation{{ $location->id }}" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					@csrf
						<div class="row">
							...
							<div class="modal-footer">
								...
								<a href="{{ URL::to('delete_location',['id'=>\base64_encode($location->id)]) }}"  class="btn btn-primary" type="submit">Submit</a>
        ...
        {{-- ----add Medicine location form-------- --}}
        <div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
            
            <span id="check_location_span" style="color:red"></span>

            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
                <h4 class="font-size-h4 font-weight-bold m-0">Add Location
                </h4>
            ...
            <form id="myform" method="post" action="{{ URL::to('add_location') }}">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label class="text-dark">Location Name</label>
                            <input type="text" name="name" class="form-control check_location" placeholder="Enter Medicine location" id="check_location">
                           
                        </div>

                    </div>
                </div>
                <button type="submit" class="btn btn-primary" id="add_btn_location">Submit</button>
            </form>
    ...
    $(document).on('keyup','.check_location',function()
    {
            var location_name=$(this).val();
            // var div=$(this).parent();
            // Ajax to load pump price
            console.log(location_name);
            $.ajax({type:'get', url:'{!! URL::to('check_location') !!}', //URL to load the data
                data:{'name': location_name}, 
                //processData: false,//contentType: false,
                success:function(data){
                    console.log(data);
                    if(data>=1){
                        var span_sms=document.getElementById('check_location_span');
                        span_sms.innerHTML="* Medicine location already exist!";
                        document.getElementById("add_btn_location").disabled = true;
                    }
                    else{
                        var span_sms=document.getElementById('check_location_span');
                        span_sms.innerHTML=" ";
                        document.getElementById("add_btn_location").disabled = false;
                    }
                },
                error:function(){
                },
