...
@section('contents')
    ...
    <body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled           aside-fixed">
                                                                        ...
                                                                        @foreach ($suppliers as $supplier)
                                                                                    ...
                                                                                    <div class="card-toolbar text-right">
                                                                                        ...
                                                                                        <div class="dropdown-menu dropdown-menu-right"
                                                                                            ...
                                                                                            <a class="dropdown-item"
                                                                                                data-toggle="modal"
                                                                                                data-target="#edit_supplier{{ $supplier->id }}">Edit</a>

                                                                                            {{-- ----delete button--------- --}}
                                                                                            <a class="dropdown-item"
                                                                                            data-toggle="modal"
                                                                                            data-target="#delete_supplier{{ $supplier->id }}"
                                                                                                title="Delete"
                                                                                                >Delete</a>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            {{-- ----edit supplier form-------- --}}
                                                                                    ...
                                                                                    <div class="modal fade"
                                                                                                    ...
                                                                                                    <form id="myform"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    type="text"
                                                                                                                    value="{{ \base64_encode($supplier->id) }}"
                                                                                                                    hidden
                                                                                                                    name="id" />
                                                                                                                <div
                                                                                                                    class="form-group">
                                                                                     ...
                                                                                     <div class="modal fade"
                                                                                     id="delete_supplier{{ $supplier->id }}"
                                                                                     tabindex="-1" role="dialog"
                                                                                     aria-labelledby="exampleModalScrollableTitle"
                                                                                     aria-hidden="true">
                                                                                     <div class="modal-dialog modal-dialog-scrollable"
                                                                                                 ...
                                                                                                 <form id="myform"
                                                                                                     ...
                                                                                                     <div
                                                                                                         ...
                                                                                                         <div
                                                                                                             ...
                                                                                                             <div>
                                                                                                                 <div>
                                                                                                                 <h5 >Are You sure you want to delete Supplier {{ $supplier->name }}?
                                                                                                                </h5>
                                                                                                                </div>
                                                                                                             </div>
                                                                                                     ...
                                                                                                     <div class="modal-footer">
                                                                                                        ...
                                                                                                        <a href="{{ URL::to('del_supplier',['id'=>\base64_encode($supplier->id)]) }}"  class="btn btn-primary">Delete</a>
        ...
        <div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
            ...
            <span id="check_supplier_span" style="color:red"></span>

            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
                <h4 class="font-size-h4 font-weight-bold m-0">Add Supplier
                </h4>
            ...
            <form id="myform" method="post" action="{{ URL::to('add_supplier') }}">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control check_supplier" id="check_supplier_name">
                            <small class="form-text text-muted">please enter Supplier Name</small>
                        </div>

                        <div class="form-group">
                            <label class="text-dark">Email</label>
                            <input type="email" name="email" class="form-control check_supplier" id="check_supplier_email">
                ...
                <button type="submit" class="btn btn-primary" id="add_btn_supplier">Add Supplier</button>
            </form>
    ...
    $(document).on('keyup','.check_supplier',function()
    {
            // var supplier_name=$(this).val();
            var supplier_name=document.getElementById('check_supplier_name').value;
            var supplier_email=document.getElementById('check_supplier_email').value;
            // Ajax to load pump price
            console.log(supplier_email);
            console.log(supplier_name);
            $.ajax({type:'get', url:'{!! URL::to('check_supplier') !!}', //URL to load the data
                data:{
                    'name': supplier_name,
                ...
                success:function(data){
                    console.log(data);
                    if(data>=1){
                        var span_sms=document.getElementById('check_supplier_span');
                        span_sms.innerHTML="* Supplier already exist!";
                        document.getElementById("add_btn_supplier").disabled = true;
                    }
                    else{
                        var span_sms=document.getElementById('check_supplier_span');
                        span_sms.innerHTML=" ";
                        document.getElementById("add_btn_supplier").disabled = false;
                    }
                },
                error:function(){
                },
