...
@section('title', 'Login-Dar West')

@section('contents')

<body id="tc_body" class="">
	   
	<div class="container-fluid h-100 bg-image" style="background-image: url(./assets/images/misc/bg-login1.jpeg);">
						...
						<div class="card-header align-items-center  justify-content-center border-0 h-100px flex-column">
							<div class="card-title mb-0">
								<h3 class="card-label font-weight-bold mb-0 text-body">
									<img src="./assets/images/misc/dw.png" alt="logo" width="180px" height="60px">
								</h3>
						...
						<div class="card-body p-0">
							<form id="myform" class="pb-5 pt-5">
								...
								<div class="form-group row ">
								    ...
								    <div class="col-lg-10 col-9 pl-0">
										<input type="password" name="password" placeholder="enter password" class="form-control text-dark bg-transparent font-size-h4 border-0 p-0 h-20px" id="exampleInputPassword1">
									</div>
								...
								<a href="{{URL::to('dashboard')}}" class="btn btn-primary text-white font-weight-bold w-100 py-3"> 
