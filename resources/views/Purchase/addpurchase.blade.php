                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <fieldset class="form-group mb-3 d-flex" >
                                                            ...
                                                            <select class="js-example-basic-single js-states form-control bg-transparent"
                                                                    name="select_medicine" id="select_medicine">
                                                                    <option value="">select medicine</option>
                                                                    @foreach ($medicines as $medicine)
                                                                    
                                                                  <option value="{{ $medicine->id }}" class="test_js">{{ $medicine->name }}</option>
                                                                    @endforeach
                                                                </select>
...
$(document).on('click','.med_purchase',function () {
    // $(document).on('change','.select_medicine',function(){
        
           
            //  var select_medicine=$(this).val();
            var med_id=document.getElementById('select_medicine').value;  
            

          const inputEl = document.querySelector('#select_medicine');
      

            var option = inputEl.children[inputEl.selectedIndex];
            var enteredValue = option.textContent;
            ...
            $.ajax({
                ...
                var op='<tr class=""> <td class="" name="select_medicine">'+ enteredValue +'</td> '+
                ...
                '<td class="select_medicine">'+ data.sell_price + '</td> '+
