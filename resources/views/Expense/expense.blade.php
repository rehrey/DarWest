...
@section('contents')
                                                ...
                                                <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                                    <div class="card-header align-items-center  border-bottom-dark px-0">
                                                        <div class="card-title mb-0">
                                                            <h3 class="card-label mb-0 font-weight-bold text-body">Expenses
                                                            </h3>
                                                        </div>
                                                                                ...
                                                                                <div class="card-toolbar text-right">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right"
                                                                                        ...
                                                                                        <a class="dropdown-item"
																							...
																							data-target="#edit_expense{{ $expense->id }}">Edit</a>
                                                                                        <a class="dropdown-item"
                                                                                            title="Delete"
                                                                                            href="#" data-toggle="modal"
																							data-target="#deleteexpense{{ $expense->id }}">Delete</a>
                                                                                    </div>
                                                                                </div>

	{{-- ----Editing Expense form-------- --}}

    <div class="modal fade" id="edit_category{{ $expense->id }}" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					action="{{ URL::to('upd_expense') }}">
					@csrf
						<div class="row">
							<div class="col-12">
								<input type="text" value="{{ \base64_encode($expense->id) }}"
                                hidden name="id" />
                                ...
                                <div class="form-group">
									...
									<fieldset>
										<select class="rounded form-control bg-transparent" name="warehouse">
                                ...
                                <div class="form-group">
									...
									<fieldset>
										<select class="rounded form-control bg-transparent" name="payment_type">
										 <option {{-- value="{{ $medicine->category "--}} selected>  {{-- $medicine->category --}} </option>
                                           {{-- @foreach ($categories as $category) --}}
                                           <option>{{-- $category->name --}} </option>
                                            {{-- @endforeach --}}
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter Amount for the expense"
							...
							<div class="modal-footer">
								...
								<a class="btn btn-primary" type="reset">Cancel</a>
    ...
    <div class="modal fade" id="deleteexpense{{ $expense->id }}" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					@csrf
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group">
									Are You sure you want to delete {{ $expense->name }} Expense of amount {{ $expense->amount }} paid by {{ $expense->payment_type }}?
								</div>
							...
							<div class="modal-footer">
								...
								<a href="{{ URL::to('delete_expense',['id'=>\base64_encode($expense->id)]) }}"  class="btn btn-primary" type="submit">Submit</a>
								<a  class="btn btn-primary" type="reset">Cancel</a>
        ...
        <div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
                <h4 class="font-size-h4 font-weight-bold m-0">Add Expenses
                </h4>
            ...
            <form id="myform" method="post" action="{{ URL::to('add_expense') }}">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label class="text-dark">Expense Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Enter the Expense">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="text-dark">Payment Method</label>
                                <select class="arabic-select w-100 mb-3 h-30px" name="payment_type">
