...
@section('contents')
                                                                                ...
                                                                                <div class="card-toolbar text-right">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right"
                                                                                        ...
                                                                                        <a class="dropdown-item"
																							...
																							data-target="#edit_unit{{ $unit->id }}">Edit</a>
                                                                                        <a class="dropdown-item"
                                                                                            title="Delete"
                                                                                            href="#" data-toggle="modal"
																							data-target="#deleteunit{{ $unit->id }}">Delete</a>
                                                                                    </div>
                                                                                </div>

	{{-- ----Editing Medicine form-------- --}}

    <div class="modal fade" id="edit_unit{{ $unit->id }}" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalScrollableTitle">
						Edit Medicine Unit </h5>
					<button type="button"
				...
				<div class="modal-body">
					...
					action="{{ URL::to('upd_unit') }}">
					@csrf
						<div class="row">
							<div class="col-12">
								<input type="text" value="{{ \base64_encode($unit->id) }}"
                                hidden name="id" />
								<div class="form-group">
									<label class="text-dark">Unit Name</label>
									<input type="text" class="form-control" placeholder="Medicine unit Name"
	...
	{{-- ----Delete Medicine Unit form-------- --}}

    <div class="modal fade" id="deleteunit{{ $unit->id }}" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalScrollableTitle">
						Delete Medicine Unit </h5>
					<button type="button"
						class="close rounded-pill btn btn-sm btn-icon btn-light btn-hover-primary m-0"
						data-dismiss="modal" aria-label="Close">
						<svg width="20px" height="20px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
					...
					@csrf
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group">
									Are You sure you want to delete {{ $unit->name }} unit?
								</div>
							...
							<div class="modal-footer">
								...
								<a href="{{ URL::to('delete_unit',['id'=>\base64_encode($unit->id)]) }}"  class="btn btn-primary" type="submit">Submit</a>
        ...
        <div id="kt_notes_panel" class="offcanvas offcanvas-right kt-color-panel p-5">
            <span id="check_unit_span" style="color:red"></span>

            <div class="offcanvas-header d-flex align-items-center justify-content-between pb-3">
                <h4 class="font-size-h4 font-weight-bold m-0">Add Medicine Unit
                </h4>
            ...
            <form id="myform" method="POST" action="{{ URL::to('add_unit') }}">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label class="text-dark">Unit Name</label>
                            <input type="text" name="name" class="form-control check_unit" placeholder="Enter Medicine Unit" id="check_unit">
                           
                        </div>

                    </div>
                </div>
                <button type="submit" class="btn btn-primary" id="add_btn_unit">Submit</button>
            </form>
    ...
    $(document).on('keyup','.check_unit',function()
    {
            var unit_name=$(this).val();
            // var div=$(this).parent();
            // Ajax to load pump price
            console.log(unit_name);
            $.ajax({type:'get', url:'{!! URL::to('check_unit') !!}', //URL to load the data
                data:{'name': unit_name}, 
                //processData: false,//contentType: false,
                success:function(data){
                    console.log(data);
                    if(data>=1){
                        var span_sms=document.getElementById('check_unit_span');
                        span_sms.innerHTML="* Medicine Unit already exist!";
                        document.getElementById("add_btn_unit").disabled = true;
                    }
                    else{
                        var span_sms=document.getElementById('check_unit_span');
                        span_sms.innerHTML=" ";
                        document.getElementById("add_btn_unit").disabled = false;
                    }
                },
                error:function(){
                },
